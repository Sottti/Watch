package com.sotti.watch.movies.domain
...
data class MovieOverviewDM(val id: Int, val title : String, val posterPath : String, val voteAverage : Float, val overview : String)